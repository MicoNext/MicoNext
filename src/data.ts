...
export const siteData = {
  ...
  hero: {
    ...
    stats: [
      ...
      { number: '8 из 10', label: 'клиентов возвращаются' },
  ...
  about: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Вливаемся в проект за 1-2 дня. Не тратим ваш ресурс на онбординг. Уважаем текущий стек и процессы, улучшаем, а не диктую правила.",
